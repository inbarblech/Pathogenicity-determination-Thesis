...
def run_opra_oda_sasa(variant_path: str) -> str:
    ...
    if not os.path.isfile(f"AF_{gene_id}_{variant_location}{three_letter_amino_acid}.pdb"):
        return f"Error, no mutation file for variant {variant_path}"
    else:
        # Run oda for mut
...
def run_oda(path_to_variant_folder: str):
    """Creates a file with the ODA score for the given PDB file."""
